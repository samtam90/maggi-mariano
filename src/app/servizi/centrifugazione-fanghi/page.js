...
export function getBaseProps({ mobile, title, locationsData }) {
  return {
    sections: {
      ...
      locations:
        locationsData ||
        getBaseLocationsData({
          links: appConfig.links.servizi["centrifugazione-fanghi"],
          serviceName: "centrifugazione fanghi",
        }),
      mainContent: {
        title: {
          left: title,
...
export const metadata = getMetadata({
  title: "Centrifugazione fanghi",
  canonicalLink: appConfig.links.servizi["centrifugazione-fanghi"].root,
});
